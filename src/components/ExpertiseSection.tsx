...
const ExpertiseSection: React.FC = () => {
  ...
  return (
    <section id="expertise" className="bg-gray-800 py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        >
          I specialize in scalable backend development, microservices architecture, cloud-native deployments on AWS, and real-time data processing using event-driven systems.
        </motion.p>
      </div>
    </section>
  );
